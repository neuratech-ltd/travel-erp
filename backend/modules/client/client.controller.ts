import { getClientById, getAllClients, Client, createClient, updateClient } from './client.services'
...
export { getClients, getClientByIdController, createClientController, updateClientController }
