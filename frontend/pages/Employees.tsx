  ...
  return (
    <div id="employees-container" className="flex-1 p-6 bg-slate-50 overflow-y-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <EmployeeStatsCard title='Total Staff' amount={555} icon={<User className="h-5 w-5" />} />
        <EmployeeStatsCard title='Active Staff' status='active' amount={45} icon={<CheckCircle className="h-5 w-5" />} />
       <EmployeeStatsCard title='Inactive Staff' status='inactive' amount={10} icon={<XCircle className="h-5 w-5" />} />
      </div>
      ...
      {/* {isLoading ? (
       ...
       <EmployeeCard setIsModalOpen={setIsModalOpen} />

      {isModalOpen && (
        <EmployeeModal setIsModalOpen={setIsModalOpen} />
      )}
