...
const HotelAndVisaForm = ({ bookingType, loading, handleSubmit }: HotelAndVisaFormProps) => {
  return (
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200/60 grid grid-cols-1 md:grid-cols-4 gap-4 text-xs">
          ...
          <div>
            ...
            <input type="text"
              ...
              className="w-full border border-slate-200 rounded-lg p-2 bg-slate-50 text-slate-800 font-bold outline-none" required />
          </div>
          ...
          {bookingType === 'Hotel' ? (
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4 text-xs animate-fade-in">
              ...
              <div>
                ...
                <input type="number" 
                  //  value={hotelSale}
                  //  onChange={(e) => setHotelSale(Number(e.target.value))}
                  className="w-full border border-slate-200 rounded-lg p-2 bg-slate-50 text-slate-800 outline-none font-bold" />
              </div>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-xs animate-fade-in">
              ...
              <div>
                ...
                <input type="number" 
                  //  value={visaSale}
                  //  onChange={(e) => setVisaSale(Number(e.target.value))}
                  className="w-full border border-slate-200 rounded-lg p-2 bg-slate-50 text-slate-800 outline-none font-bold" />
              </div>
            </div>
          )}
