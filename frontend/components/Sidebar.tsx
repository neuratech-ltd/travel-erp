...
export default function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  const menuItems = [
    ...
    { id: 'employees', label: 'Employees', icon: User, section: 'Core' },
    { id: 'air-ticket', label: 'New Air Ticket', icon: Plane, section: 'Invoicing' },
    { id: 'non-commission', label: 'Non Commission', icon: Coins, section: 'Invoicing' },
    { id: 'reissue', label: 'Reissue Invoice', icon: RefreshCw, section: 'Invoicing' },
    { id: 'tour-package', label: 'Holiday & Medical', icon: Briefcase, section: 'Packages' },
    { id: 'hotel-visa', label: 'Hotel & Visa', icon: Hotel, section: 'Packages' },
    { id: 'ledger', label: 'Invoice Ledger', icon: FileText, section: 'Financials' },
    { id: 'sales-report', label: 'Sales Spreadsheet', icon: FileSpreadsheet, section: 'Financials' },
    { id: 'ai-consultant', label: 'AI Consultant', icon: Sparkles, section: 'Intelligence' },
  ];
