...
const AddClientModal = ({ setIsModalOpen }: AddClientModalProps) => {
  return (
    <div>
      <div
        id="modal-overlay"
        ...
        <div id="modal-drawer" className="w-full max-w-md bg-white h-full shadow-2xl flex flex-col animate-slide-left">
          <div className="p-5 border-b border-slate-100 flex items-center justify-between bg-[#0A1D1C] text-white">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="font-bold text-sm uppercase tracking-wide">Add New Client</h3>
                <p className="text-4xs text-emerald-300">Fill in the details to add a new client</p>
              </div>
            </div>
            <button
